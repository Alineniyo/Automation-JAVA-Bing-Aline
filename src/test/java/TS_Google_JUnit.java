...
public class TS_Google_JUnit {
    ...
    @Test
    @Tag("e2e_test")
    @DisplayName("TC - Bing - Search for Netflix")
    public void tc_bing_search_for_netflix() {
        FW_CustomAssertJU.autoPass(po_Home.navigateTo("https://www.bing.com/"));
        FW_CustomAssertJU.autoPass(po_Home.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Home.enterSearch("Netflix"));
        FW_CustomAssertJU.autoPass(po_Home.clickBingSearchIcon());
